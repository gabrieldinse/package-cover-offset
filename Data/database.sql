...
-- Dumping database structure for controle_producao
CREATE DATABASE IF NOT EXISTS `controle_producao` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `controle_producao`;

-- Dumping structure for table controle_producao.producao
...
-- Dumping structure for table controle_producao.producao_tipo_produto
CREATE TABLE IF NOT EXISTS `producao_tipo_produto` (
  `IdTipoProduto` int(10) unsigned DEFAULT NULL,
  `IdProducao` int(10) unsigned DEFAULT NULL,
  KEY `FK_produto_tipo_produto_tipo_produto` (`IdProducao`),
  KEY `FK_produto_tipo_produto_produto` (`IdTipoProduto`),
  CONSTRAINT `FK_produto_tipo_produto_produto` FOREIGN KEY (`IdTipoProduto`) REFERENCES `tipo_produto` (`Id`),
  CONSTRAINT `FK_produto_tipo_produto_tipo_produto` FOREIGN KEY (`IdProducao`) REFERENCES `producao` (`Id`)
...
-- Dumping structure for table controle_producao.produto_producao
CREATE TABLE IF NOT EXISTS `produto_producao` (
  `IdProducao` int(10) unsigned DEFAULT NULL,
  `IdProduto` int(10) unsigned DEFAULT NULL,
  KEY `IDProducao` (`IdProducao`),
  KEY `IDProduto` (`IdProduto`),
  CONSTRAINT `IDProducao` FOREIGN KEY (`IdProducao`) REFERENCES `producao` (`Id`),
  CONSTRAINT `IDProduto` FOREIGN KEY (`IdProduto`) REFERENCES `produto` (`Id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- Data exporting was unselected.

-- Dumping structure for table controle_producao.tipo_produto
